...
import com.kgtts.kgtts_app.MainActivity

/**
 * Bridge for overlay → app communication.
 * Preserved from original Android app for FloatingOverlayService integration.
 */
object OverlayBridge {
    ...
    fun buildQuickSubtitleIntent(
        ...
        return Intent(context, MainActivity::class.java).apply {
            ...
            putExtra(EXTRA_REQUEST_ID, android.os.SystemClock.uptimeMillis())
